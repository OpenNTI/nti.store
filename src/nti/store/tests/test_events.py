...
class TestEvents(unittest.TestCase):
    ...
    def _create_purchase_attempt(self, item=None, quantity=None, state=None, user=None):
        ...
        result = create_purchase_attempt(order, processor=u'stripe',
                                         state=state)
        if user is not None:
    ...
    def create_gift_attempt(self, creator, item=u'xyz-book', state=None):
        ...
        result = create_gift_purchase_attempt(order=order, processor=u'stripe',
    ...
    def test_success(self):
        ...
        pa = self._create_purchase_attempt(quantity=5,
    ...
    def test_invitation_refund(self):
        user = self._create_user()
        pa = self._create_purchase_attempt(state=PA_STATE_SUCCESS, user=user)
        inv = self._create_purchase_attempt(quantity=5,
    ...
    def test_redeemed_refund(self):
        ...
        user2 = self._create_user(username=u"ichigo")
    ...
    def test_redeemed_gift(self):
        ...
        aizen = self._create_user(username=u"aizen")
