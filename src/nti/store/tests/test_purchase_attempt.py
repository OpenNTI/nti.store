...
class TestPurchaseAttempt(unittest.TestCase):
    ...
    def create_gift_attempt(self, creator, item=u'xyz-book', state=None):
        ...
        result = create_gift_purchase_attempt(order=order, processor=self.processor,
                                              ...
                                              receiver=u"azien@bleach.org",
                                              receiver_name=u"Azien Sosuke",
    ...
    def test_simple_purchase_attempt(self):
        ...
        assert_that(purchase, has_property('Items', is_(('xyz',))))

        order = purchase.Order
        assert_that(order, has_length(1))
        assert_that(order, has_property('Quantity', is_(none())))
        assert_that(order, has_property('NTIIDs', is_(('xyz',))))
    ...
    def test_simple_gift_purchase_attempt(self):
        ...
        assert_that(attempt,
                    has_property('SenderName', is_('Ichigo Kurosaki')))
