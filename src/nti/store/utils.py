...
PURCHASABLE_ATTEMPT_MIME_TYPES.append(STORE_MIME_BASE + b'.purchasable')
PURCHASABLE_ATTEMPT_MIME_TYPES.append(STORE_MIME_BASE + b'.purchasablecourse')
PURCHASABLE_ATTEMPT_MIME_TYPES.append(STORE_MIME_BASE + b'.purchasablechoicebundle')
PURCHASABLE_ATTEMPT_MIME_TYPES.append(STORE_MIME_BASE + b'.purchasablecoursechoicebundle')
